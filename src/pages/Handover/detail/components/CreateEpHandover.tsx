...
export interface AddFormValueType extends EPHandoverMessageItem {
...
interface CreateEpHandoverFormProps {
    ...
    onSubmit: (fieldsValue: AddFormValueType) => void;
    onCancel: () => void;
    forecastCode: string;
}
...
const CreateEpHandoverByCodeForm: React.FC<CreateEpHandoverFormProps> = (props) => {
    ...
    const { modalVisible, onSubmit: handleAdd, onCancel, forecastCode} = props;
    const okHandle = async () => {
        const fieldsValue = await form.validateFields() as AddFormValueType;
        form.resetFields();
                ...
                <Row gutter={24}>
                    <Col span={12}>
                        <FormItem
                            ...
                            name="forecastCode"
                        >
                            <Input disabled={true} defaultValue={forecastCode} placeholder="请输入" />
                        </FormItem>
                    </Col>
                    <Col span={12}>
                        <FormItem
